<div class="container-fluid bg-white" id="navbar">
	<div class="row">
		<div class="section font-black-darken">
			<div class="col-md-2 col-xs-8"><a href="<?php echo base_url('/'); ?>"><img src="<?php echo base_url('assets/front/images/lmi-logo.png'); ?>" width="100%"></a></div>
			...
			<div class="col-md-10 col-xs-12 font-sm font-medium text-right">
				<ul>
					<li class="hvr-underline-from-left"><a href="<?php echo base_url('/admin'); ?>">Admin</a></li>
